...
# fraud_detection_kedro documentation build
...
from fraud_detection_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "fraud_detection_kedro"
author = "QuantumBlack"
...
htmlhelp_basename = "fraud_detection_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "fraud_detection_kedro.tex",
        "fraud_detection_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "fraud_detection_kedro",
        "Project fraud_detection_kedro codebase.",
        "Data-Science",
    )
]
